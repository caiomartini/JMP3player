...
<body>
    ...
    <div id="content" align="center">
    	<h1>Adicionar Novo Artista no Repositório</h1>
    	<form method="get">
	    	<p>Nome do Artista: </p><input type="text" name="nome"><br/>
	    	<p>País de Origem: </p><input type="text" name="pais"><br/>
	    ...
	    try {
		    ...
		    if(request.getParameter("pais") != null) {
		    	pais = Pais.deStringParaEnum(request.getParameter("pais"));	
		    }	
			
		    if(nome != null && pais != null) {
		    	Artista artista = new Artista(nome, pais);
		    	MP3Player.repositorio.adicionarArtista(artista);		    	
		    	response.sendRedirect("./sucesso.html");
		    }
		    
	    } catch (Exception e) { 
	    	throw new Exception("Falha ao tentar cadastrar Artista"); 
	    }
	    %>
    </div>
    <div id="footer">
