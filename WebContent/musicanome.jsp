...
<body>
	...
	<div id="content" align="center">
		<form method="get">
			<h1><i class="fa fa-search"></i> Pesquisar Música por Nome</h1>
			<input type="text" name="nome" value="<%=request.getParameter("nome") != null ? request.getParameter("nome") : ""%>">
			...
			try 
			{
				if(request.getParameter("nome") != null) {
					...
					Musica locMusica = MP3Player.repositorio.localizarMusica(nome);
					if(locMusica != null) {
						%>
