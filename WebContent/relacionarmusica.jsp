    ...
    <div id="content" align="center">
    	...
    	<form method="get">
			...
			if(musicasSemAlbum.size() > 0) {
				...
				<h2>Albums do Repositório</h2>
				<table class="table">
					<tr>
						<td><p></p></td>
						<td><p>Album</p></td>
						<td><p>Lançamento</p></td>
						<td><p>Total</p></td>
						<td><p>Tempo</p></td>
					</tr>
					<%
				...
				%>
				<h3>Nenhuma Música sem Album foi encontrada</h3>
				<%
			}
	    	%>	    	
    	</form>    	
    	...
    	try {
		    ...
		    if(codmusica != 0 && codalbum != 0) {
		    	...
		    	%>
		    	<p class="success">Música adicionada no Album</p>
		    	<%
