...
<body>
	<%
	if(MP3Player.repositorio == null) {
		MP3Player.iniciaMP3Player();	
	}	
	%>
	<div id="header">
	...
	<div id="content" align="center">
		<h1><i class="fa fa-play-circle"></i> Bem vindos ao MP3 Player Online</h1>
		<p>Adicione suas Músicas, seus Artistas e seus Albums favoritos no Repositório.</p>
		<p>Crie sua Lista de Reprodução personalizada para ouvir onde quiser.</p>
	</div>	
	<div id="footer">
